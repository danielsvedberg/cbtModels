...
def init_params(
    ...
    params = {
        ...
        # Cortex exc → striatum / SNc / medulla / STN.
...
def multiregion_rnn(params, config, inputs, opto_stimulation=None, rng_key=None):
    ...
    def _step(carry, inp_stim_rng):
        (x_d1, x_d2,
         x_c_exc, x_c_inh,
         x_t_exc, x_t_inh,
         x_snr, x_gpe, x_stn, x_snc, pka_d1, pka_d2, x_med) = carry
        ...
        (rng_d1, rng_d2,
         rng_c_exc, rng_c_inh,
         rng_t_exc, rng_t_inh,
         rng_snr, rng_gpe, rng_stn, rng_snc, rng_med) = jr.split(step_rng, 11)
        ...
        new_carry = (x_d1, x_d2,
                     x_c_exc, x_c_inh,
                     x_t_exc, x_t_inh,
                     x_snr, x_gpe, x_stn, x_snc, pka_d1, pka_d2, x_med)
    ...
    _, (ys, xc, xd1, xd2, xsnc, xgpe, xstn, xsnr, xt, pkad1, pkad2, xmed) = lax.scan(
        ...
        (x_d10, x_d20,
         x_c0_exc, x_c0_inh,
         x_t0_exc, x_t0_inh,
         x_snr0, x_gpe0, x_stn0, x_snc0, pka_d10, pka_d20, x_med0),
